...
// Declare the finite state machine golbal variables
...
extern const struct CarFSM FSM_CarTrafficLight[6];
...
extern const struct PedFSM FSM_PedestrianTrafficLight[4];
